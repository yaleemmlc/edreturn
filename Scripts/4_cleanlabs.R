#4) Cleans the labs csv file to return a wide dataframe with common labs as columns.
# uses the same script as the 6_cleanlabs.R script in the triage admission project
