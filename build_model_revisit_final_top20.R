#Training model using optimized set of hyperparmeters and testing on test set (ED revisit - 9 days, Top 20 variables)
...
#save for future use
y_hat_test_top20 <- y_hat_test
save(y_hat_test_top20, file = './Results/y_hat_test_xgb_9day_top20.RData')
