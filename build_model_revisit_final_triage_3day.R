#Training model using optimized set of hyperparmeters and testing on test set (ED revisit - 72 hours, triage)
setwd('~/ED_Return/')
...
#save for future use
y_hat_test_triage_3day <- y_hat_test
y_test_3day <- y_test
save(y_hat_test_triage_3day, file = './Results/y_hat_test_xgb_3day_triage.RData')
save(y_test_3day, file = './Results/y_test_3day.RData')
