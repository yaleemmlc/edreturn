#Training model using optimized set of hyperparmeters and testing on test set (ED revisit - 72 hours, Top 20 variables)
...
load('./Results/sparseMatrix_revisit_top20_3day.RData')
x <- dataset$x
y <- dataset$y
rm(dataset)
...
#save for future use
y_hat_test_top20_3day <- y_hat_test
save(y_hat_test_top20_3day, file = './Results/y_hat_test_xgb_9day_top20_3day.RData')
save(y_test, file = './Results/y_test_3day.RData')
