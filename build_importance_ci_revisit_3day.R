#Get mean information gain for each variable from 100 runs of XGBoost (72 hours, full dataset)
setwd('~/ED_Return/')
...
save(result, file = './Results/bst_importance_100_revisit_3day.RData')
