#Training model using optimized set of hyperparmeters and testing on test set (ED revisit - 72 hours)
setwd('~/ED_Return/')
...
#train using optimized set of hyperparameters
...
y_hat_test_3day <- y_hat_test
save(y_hat_test_3day, file = './Results/y_hat_test_xgb_3day.RData')
